...
(ref:chaff-fig) Box plot of the mass of chaffinches for males and females, lines show whatever.

```{r chaff_plot, fig.height=4, fig.width=4, fig.cap="(ref:chaff-fig)"}
